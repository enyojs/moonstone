enyo.kind({
    name: "moon.sample.ActivityPatternOnePanelUp2Sample",
    kind: "FittableRows",
            ...
            components: [
                {
                    ...
                    style: "width: 25%;",
                    components: [
                        {name: "movie", kind: "enyo.Image", src: "assets/default-movie-vertical.png", style: "width: 100%; padding: 28px 0px 0px 0px;"},
                            ...
                            components: [
                                {
                                    ...
                                    components: [
                                        {
                                            kind: "FittableRows",
                                            style: "width: 140px; margin: 0px 50px 0px 0px;",
                                            components: [
