enyo.kind({
	name: "enyo.sample.ListHorizontalSample",
	...
	components: [
		{kind: 'enyo.Spotlight'},	
		{name: "list", kind: "moon.List", orient:"h", count: 20000, multiSelect: false, classes: "enyo-fit list-horizontal-controls-sample-list", style:"height:300px;", onSetupItem: "setupItem", components: [
