enyo.kind({
	...
	components: [
		{kind: "moon.Panel", classes: "enyo-fit", title:"Text Scrolling Sample", titleBelow:"Scroller buttons are focusable", headerComponents: [
			{kind: "moon.IconButton"}
		], components: [
			{kind:"moon.Divider", content:"Terms of Service"},
	...
	bindings: [
		{from: ".$.lengthToggle.active", to:".$.text.content", transform: function(val) { return val ? this.longText : this.shortText; } },
		{from: ".$.spotToggle.active", to:".$.scroller.spotlightPagingControls" }
	]
});
