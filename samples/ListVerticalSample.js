enyo.kind({
	...
	components: [
		{kind: 'enyo.Spotlight'},	
		{name: "list", kind: "moon.List", orient:"v", count: 20000, multiSelect: false, classes: "enyo-fit list-horizontal-controls-sample-list", onSetupItem: "setupItem", components: [
