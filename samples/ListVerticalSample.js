enyo.kind({
	...
	components: [
		{kind: 'enyo.Spotlight'},
		{name: "list", kind: "moon.List", spotlight: true, orient:"v", count: 300, multiSelect: false, classes: "enyo-fit list-vertical-controls-sample-list moon-list-vertical-sample",
