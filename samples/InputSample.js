enyo.kind({
	...
	components: [
		...
		{components: [
			{kind: "moon.InputDecorator", spotlight: true, components: [
				{kind: "moon.Input", placeholder: "Bottom", onchange:"inputChanged"}
			]},
			{kind: "moon.InputDecorator", spotlight: true, components: [
				{kind: "moon.Input", placeholder: "Aligned", onchange:"inputChanged"}
			]},
			{kind: "moon.InputDecorator", spotlight: true, components: [
				{kind: "moon.Input", placeholder: "Inputs", onchange:"inputChanged"}
			]}
		]}
	],
