enyo.kind({
	...
	components: [
		{fit:true, components: [
			...
			{classes:"moon-1v"},
			{kind: "moon.Divider", content: "LG Icons:"},
			{kind: "moon.Icon", icon: '&#42276;', classes: "font-lg-icons", small: false, ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: '&#42381;', classes: "font-lg-icons", small: false, ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: '&#42391;', classes: "font-lg-icons", small: false, ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: '&#42322;', classes: "font-lg-icons", small: false, ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: 'ꔤ', classes: "font-lg-icons", ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: 'ꖍ', classes: "font-lg-icons", ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: 'ꖗ', classes: "font-lg-icons", ontap: "buttonTapped"},
			{kind: "moon.Icon", icon: 'ꕒ', classes: "font-lg-icons", ontap: "buttonTapped"},
			{classes:"moon-1v"},
