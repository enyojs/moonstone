...
module.exports = kind(
	...
	*/
	published: {
		...
		*/
		...
		/**
		* When `true`, the value of {@link module:moonstone/LabeledTextItem~LabeledTextItem#text}
		* will be wrapped instead of marqueed.
		*
		* @type {Boolean}
		* @default true
		* @public
	...
	*/
	components:[
		...
		{name: 'text', kind: Marquee.Text, classes: 'moon-labeledtextitem-text', accessibilityDisabled: true}
	],

	initComponents: function () {
		this.kindComponents = Component.overrideComponents(this.kindComponents, {text: {wrapInsteadOfMarquee: this.textWrapped}});
		Item.prototype.initComponents.apply(this, arguments);
	}
});