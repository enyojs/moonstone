	...
	*/
	...
	ariaObservers: [
		{path: ['dayText', 'monthText', 'yearText'], method: function () {
			this.$.hour.setAriaAttribute('aria-label', this.hourText);
			this.$.minute.setAriaAttribute('aria-label', this.minuteText);
			if (this.$.meridiem) this.$.meridiem.setAriaAttribute('aria-label', this.meridiemText);
		}}
	]
});
