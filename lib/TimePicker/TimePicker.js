...
var HourMinutePickerBase = kind(
	...
	*/
	create: function () {
		...
		this.date = DateFactory.newInstance();
	},
...
var TimePicker = module.exports = kind(
	...
	*/
	initILib: function () {
		...
		if (this.meridiemEnable) {
			...
			var am = DateFactory.newInstance({hour:10});
			var pm = DateFactory.newInstance({hour:14});
	...
	*/
	formatValue: function () {
		...
		return this._tf.format(DateFactory.newInstance({unixtime: this.value.getTime(), timezone:'Etc/UTC'}));
	},
