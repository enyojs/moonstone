...
var History = module.exports = kind.singleton({
	...
	* `history.go()`. For our purposes, we only want {@link module:moonstone/History~History} to only handle
...
/**
* {@link module:moonstone/History~History} is a {@glossary mixin} that enables support for custom history. In its
...
/** @lends module:moonstone/HistorySupport~HistorySupport.prototype */
