...
var History = module.exports = kind.singleton({
	...
	* `history.go()`. For our purposes, we only want {@link module:moon/History} to only handle
...
/**
* {@link module:moon.History} is a {@glossary mixin} that enables support for custom history. In its
