...
/**
* Contains the declaration for the {@link moon.Scroller} kind. On platforms with touch support, it will
* return {@link enyo.Scroller}.
...
if (platform.touch) {
	...
	* @ui
	* @definedby module:moonstone/Scroller
	* @public
	*/
	module.exports = kind(
