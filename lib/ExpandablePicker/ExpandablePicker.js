...
module.exports = kind(
	...
	*/
	currentValueText: function () {
		if (this.multipleSelection && !this.getSelected().length && !this.getSelectedIndex().length ||
				!this.getSelected() && this.getSelectedIndex() == -1) {
			...
			return this.selected.get('content');
		}
	},
	...
	*/
	...
	ariaObservers: [
		{path: 'multipleSelection', to: 'aria-multiselectable'}
	]
});
