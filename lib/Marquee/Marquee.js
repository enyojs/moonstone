...
/**
* Contains the declaration for the {@link module:moonstone/MarqueeSupport~MarqueeSupport} mixin and the {@link module:moonstone/MarqueeText~MarqueeText} &
* {@link module:moonstone/MarqueeDecorator~MarqueeDecorator} kinds.
...
*
* @event module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarquee
* @type {Object}
...
*
* @event module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStart
* @type {Object}
* @property {Object} originator - A reference to the originator of this event.
* @private
*/
...
*
* @event module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStop
* @type {Object}
* @property {Object} originator - A reference to the originator of this event.
* @private
*/
...
*
* @event module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeEnable
* @type {Object}
* @private
*/
...
*
* @event module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeDisable
* @type {Object}
* @private
*/
...
*
* @event module:moonstone/MarqueeItem~MarqueeItem#onMarqueeEnded
* @type {Object}
* @private
*/

/**
* The {@link module:moonstone/MarqueeSupport~MarqueeSupport} [mixin]{@glossary mixin} should be used with controls
* that contain multiple marquees whose animation behavior should be synchronized. Calling
* [this.startMarquee()]{@link module:moonstone/MarqueeSupport~MarqueeSupport#startMarquee} or
* [this.stopMarquee()]{@link module:moonstone/MarqueeSupport~MarqueeSupport#stopMarquee} will start or stop all
* contained marquees.
*
* The following properties, defined on the base kind to which the mixin is applied,
* control the marquee behavior:
*
* [marqueeOnSpotlight]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnSpotlight}: When `true`, marquee
* starts when control is spotlight focused and ends when it is spotlight blurred.
*
* [marqueeOnHover]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnHover}: When `true`, marquee runs
* while control is hovered over with the mouse. This property is ignored if
* `marqueeOnSpotlight` is `true`.
*
* [marqueeOnRender]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnRender}: When `true`, marquee starts
* running as soon as control is rendered, and runs continuously.
*
* [marqueeSpeed]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeSpeed}: The speed of the marquee animation,
* in pixels per second.
*
* [marqueeDelay]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeDelay}: The delay between spotlight
* focus/hover and the start of the animation. (This is only used when either
* `marqueeOnSpotlight` or `marqueeOnHover` is `true`).
*
* [marqueeOnRenderDelay]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnRenderDelay}: Used when you want
* the marquee to run on render, after a specified delay.
*
* [marqueePause]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueePause}: The duration in milliseconds that
...
var MarqueeSupport = exports.Support = {
	...
	* property is ignored if [marqueeOnSpotlight]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnSpotlight}
	* is `true`.
	*
	* @type {Boolean}
	* @default undefined
	...
	* used when either [marqueeOnSpotlight]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnSpotlight} or
	* [marqueeOnHover]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnHover} is `true`.)
	*
	* @type {Number}
	* @default undefined
	* @public
	...
	*/
	...
	/**
	* If {@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnRender} is `true`, kicks off marquee animation.
	*
	* @method
	* @private
	*/
	...
	*/
	...
	/**
	* Handles external requests to kick off {@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeStart}.
	*
	* @private
	*/
	...
	* [marqueeWaitList]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeWaitList}.
	*
	* @private
	*/
	...
	* [onRequestMarqueeStart]{@link module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStart} event
	...
	*/
	...
	/**
	* Waterfalls an [onRequestMarqueeStop]{@link module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStop}
	...
	* [marqueeOnSpotlight]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnSpotlight} and
	* [marqueeOnRender]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeOnRender} settings).
	*
	* @public
	*/
	...
	* [marqueeWaitList]{@link module:moonstone/MarqueeSupport~MarqueeSupport#marqueeWaitList}.
	*
	* @fires module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarquee
	* @private
	*/
	...
	*
	* @fires module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStart
	* @private
	*/
	...
	*
	* @fires module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeStop
	* @private
	*/
	...
	*
	* @fires module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeEnable
	* @private
	*/
	...
	*
	* @fires module:moonstone/MarqueeSupport~MarqueeSupport#onRequestMarqueeDisable
	* @private
	*/
...
/**
* The {@link module:moonstone/MarqueeItem~MarqueeItem} mixin is used to add marquee animation functionality
* to a control.
*
...
var MarqueeItem = exports.Item = {
	...
	*/
	events: {
		...
		/**
		* {@link module:moonstone/MarqueeItem~MarqueeItem#onMarqueeEnded}
		*/
		onMarqueeEnded:''
	},
	...
	*
	* @fires module:moonstone/MarqueeItem~MarqueeItem#onMarqueeEnded
	* @private
	*/
...
/**
* {@link module:moonstone/MarqueeText~MarqueeText} is a basic text control that supports marquee animation.
* When `moon.MarqueeText` objects are used inside a
* [moon.MarqueeDecorator]{@link module:moonstone/MarqueeDecorator~MarqueeDecorator}, the decorator synchronizes
* their start times; the user may start a marquee programmatically by calling
* [startMarquee()]{@link module:moonstone/MarqueeSupport~MarqueeSupport#startMarquee}.
*
* ```
* enyo.kind({
* 	name: 'moon.Header',
...
* [MarqueeSupport]{@link module:moonstone/MarqueeSupport~MarqueeSupport} mixin:
*
* ```
* enyo.kind({
...
*/
exports.Text = kind(
	/** @lends module:moonstone/MarqueeText~MarqueeText.prototype */ {
...
/**
* {@link module:moonstone/MarqueeDecorator~MarqueeDecorator} is a wrapper for {@link module:moonstone/MarqueeText~MarqueeText} objects.
*
...
var MarqueeDecorator = kind(
	/** @lends module:moonstone/MarqueeDecorator~MarqueeDecorator.prototype */ {
...
/**
* The {@link module:moonstone/MarqueeDecorator~MarqueeDecorator} mixin export
* @public
*/
