...
module.exports = kind(
	...
	*/
	components: [
		{name: 'header', kind: ExpandableListItemHeader, onSpotlightFocus: 'headerFocus', ontap: 'headerTapped'},
		{name: 'drawer', kind: ExpandableListItemDrawer, resizeContainer: false, classes: 'moon-expandable-list-item-client'}
	],
	...
	*/
	expandContract: function () {
		...
		if (!Spotlight.getPointerMode()) {
			spot = this.active ? Spotlight.getFirstChild(this.$.drawer) : this.$.header;
			Spotlight.spot(spot);
		}
	},
	...
	* @private
	*/
	headerFocus: function (sender, event) {
		var direction = event && event.dir;
