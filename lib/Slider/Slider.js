...
module.exports = kind(
	...
	*/
	jumpWrapperComponents: [
		{name: 'buttonLeft', kind: IconButton, noBackground: true, classes: 'moon-simple-picker-button left', icon: 'arrowlargeleft', onSpotlightLeft: 'buttonSpotLeft', onSpotlightRight: 'buttonSpotRight', onSpotlightKeyDown: 'configureSpotlightHoldPulse', onSpotlightSelect: 'left', onSpotlightLeft: 'buttonSpotLeft', ondown: 'downLeft', onholdpulse: 'left', defaultSpotlightDisappear: 'buttonRight'},
		{name: 'sliderWrapper', classes: 'moon-slider', spotlight: true},
		{name: 'buttonRight', kind: IconButton, noBackground: true, classes: 'moon-simple-picker-button right', icon: 'arrowlargeright', onSpotlightLeft: 'buttonSpotLeft', onSpotlightRight: 'buttonSpotRight', onSpotlightKeyDown: 'configureSpotlightHoldPulse', onSpotlightSelect: 'right', onSpotlightLeft: 'buttonSpotLeft', ondown: 'downRight', onholdpulse: 'right', defaultSpotlightDisappear: 'buttonLeft'}
	],
	...
	* @private
	*/
	buttonSpotLeft: function(sender, e) {
		var v;

		if (this.enableJumpIncrement) {
			if (sender == this.$.buttonLeft) v = this.getValue() - (this.jumpIncrement || 1);
			else return false;
	...
	* @private
	*/
	buttonSpotRight: function(sender, e) {
		var v;

		if (this.enableJumpIncrement) {
			if (sender == this.$.buttonRight) v = this.getValue() + (this.jumpIncrement || 1);
			else return false;
