...
module.exports = kind(
	...
	*/
	jumpWrapperComponents: [
		{name: 'buttonLeft', kind: IconButton, backgroundOpacity: 'transparent', classes: 'moon-slider-button left', icon: 'arrowlargeleft', onSpotlightKeyDown: 'showKnobStatus', onSpotlightSelect: 'previous', ondown: 'downLeft', onup: 'hideKnobStatus', onholdpulse: 'holdLeft', ondragstart: 'preventDrag', defaultSpotlightDisappear: 'buttonRight'},
		{name: 'slider', classes: 'moon-slider', spotlight: true},
		{name: 'buttonRight', kind: IconButton, backgroundOpacity: 'transparent', classes: 'moon-slider-button right', icon: 'arrowlargeright', onSpotlightKeyDown: 'showKnobStatus', onSpotlightSelect: 'next', ondown: 'downRight', onup: 'hideKnobStatus', onholdpulse: 'holdRight', ondragstart: 'preventDrag', defaultSpotlightDisappear: 'buttonLeft'}
	],
	...
	*/
	previous: function () {
		...
		if (this.popup && this.$.popup.getShowing()) return true;
	},
