...
*
* @event module:moonstone/CalendarDate~CalendarDate#onDateSelected
* @type {Object}
* @public
*/
...
/**
* {@link module:moonstone/CalendarDate~CalendarDate} implements a control representing a single day, used by
...
var CalendarDate = kind(
	/** @lends module:moonstone/CalendarDate~CalendarDate.prototype */ {
	...
	*/
	...
	/**
	* @private
	* @fires module:moonstone/CalendarDate~CalendarDate#onDateSelected
	*/
	tap: function () {
		this.doDateSelected();
	}
...
/**
* {@link module:moonstone/SimpleMonthPicker~SimpleMonthPicker} implements a control representing the month picker,
...
var SimpleMonthPicker = kind(
	/** @lends module:moonstone/SimpleMonthPicker~SimpleMonthPicker.prototype */ {
	...
	* @private
	*/
	published: /** @lends module:moonstone/SimpleMonthPicker~SimpleMonthPicker.prototype */ {
...
module.exports = kind(
	...
	*/
	...
	/**
	* Responds to selection of a particular [CalendarDate]{@link module:moonstone/CalendarDate~CalendarDate}.
	*
	* @private
	*/
