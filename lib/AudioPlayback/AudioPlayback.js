...
/**
* Contains the declaration for the {@link module:moonstone/AudioPlayback~AudioPlayback} kind.
...
var AudioListItem = kind(
	/** @lends module:moonstone/AudioListItem~AudioListItem.prototype */ {
	...
	*/
	events: {
		...
		/**
		* {@link module:moonstone/AudioListItem~AudioListItem#event:onRemove}
		*/
		onRemove: ''
	},
	...
	*/
	...
	/**
	* @fires module:moonstone/AudioListItem~AudioListItem#onRemove
	* @private
	*/
...
var AudioPlaybackQueue = kind(
	/** @lends module:moonstone/AudioPlaybackQueue~AudioPlaybackQueue.prototype */ {
...
* 2.4, and this code hasn't yet been updated to use {@link module:moonstone/DataList~DataList}.
*
* `moon.AudioPlayback` is meant to be used with {@link module:moonstone/Drawers~Drawers}.
* This extends a {@link module:moonstone/Drawer~Drawer} by adding an audio playback control
* and playlist for the imported audio.
*
* ```
* var
*     Drawers = accordion('moonstone/Drawers'),
*     DrawerHandle = accordion('moonstone/DrawerHandle'),
*     AudioPlayback = accordion('moonstone/AudioPlayback');
*
...
*
* @class AudioPlayback
* @extends module:moonstone/Drawer~Drawer
* @ui
* @public
*/
...
module.exports = kind(
			...
			{classes: 'moon-audio-play-controls', fit: true, components: [
				...
				{kind: FittableColumns, rtl: false, classes: '', components: [
					...
					{classes: 'moon-audio-slider-container enyo-inline', fit: true, components: [
						{kind: Slider, name: 'slider', classes: 'moon-audio-slider', rtl: false, noPopup: true, lockBar: true, onChanging: 'sliderChanging', onAnimateFinish: 'sliderChanging'}
					]},
	...
	*
	* @fires module:moonstone/AudioPlayback~AudioPlayback#onAddAudio
