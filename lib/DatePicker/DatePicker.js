	...
	*/
	...
	ariaObservers: [
		{path: ['dayText', 'monthText', 'yearText'], method: function () {
			this.$.day.setAriaAttribute('aria-label', this.dayText);
			this.$.month.setAriaAttribute('aria-label', this.monthText);
			this.$.year.setAriaAttribute('aria-label', this.yearText);
		}}
	]
});
