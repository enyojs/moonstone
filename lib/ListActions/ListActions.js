...
/**
* Contains the declaration for the {@link module:moonstone/ListActions~ListActions} and {@link module:moonstone/ListActionsDrawer~ListActionsDrawer} kinds.
...
/**
* Fires when the [ListActionsDrawer]{@link module:moonstone/ListActionsDrawer~ListActionsDrawer} has completed any
* setup and/or preparation work, e.g., when animating or initial setup. No event-specific
* information is sent with this event.
*
* @event module:moonstone/ListActionsDrawer~ListActionsDrawer#onComplete
* @type {Object}
* @public
*/

/**
* {@link module:moonstone/ListActionsDrawer~ListActionsDrawer} is a [control]{@link module:enyo/Control~Control} used by
...
var ListActionsDrawer = kind(
	/** @lends module:moonstone/ListActionsDrawer~ListActionsDrawer */ {
	...
	*/
	...
	/**
	* @private
	* @lends module:moonstone/ListActionsDrawer~ListActionsDrawer.prototype
	*/
	published: {
	...
	*/
	...
	/**
	* @fires module:moonstone/ListActionsDrawer~ListActionsDrawer#onComplete
	* @private
	*/
	rendered: function() {
	...
	* [ListActionsDrawer]{@link module:moonstone/ListActionsDrawer~ListActionsDrawer} instance will bubble to the owner
...
/**
* The {@link module:moonstone/ListActionsDrawer~ListActionsDrawer} kind
*/
