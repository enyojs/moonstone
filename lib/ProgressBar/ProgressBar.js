...
var
	ProgressBarAccessibilitySupport = require('./ProgressBarAccessibilitySupport');
...
module.exports = kind(
	...
	* @private
	*/
	mixins: options.accessibility ? [ProgressBarAccessibilitySupport] : null,
	...
	*/
	popupComponents: [
		{name: 'popup', accessibilityDisabled: true, kind: Popup, classes: 'moon-progress-bar-popup above', components: [
