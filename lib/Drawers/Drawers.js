...
*
* @event module:moonstone/Drawers~Drawers#onDrawersRendered
* @type {Object}
...
*
* @event module:moonstone/Drawers~Drawers#onDrawersResized
* @type {Object}
* @property {Number} drawersHeight - The height of the drawer.
* @public
*/
...
module.exports = kind(
	...
	*/
	components: [
		...
		{name: 'drawers', kind: Control, classes: 'moon-drawers-drawer-container', ontransitionend: 'transitionend', onwebkitTransitionEnd: 'transitionend'},
	...
	* @fires module:moonstone/Drawers~Drawers#onDrawersRendered
	* @private
	*/
	rendered: function () {
	...
	*/
	animate: function(height) {
		dom.transform(this.$.drawers, {translateY: height + 'px'});
		dom.transform(this.$.client, {translateY: height + 'px'});
	},
	...
	*/
	...
	/**
	* @fires module:moonstone/Drawers~Drawers#onDrawersResized
	* @private
	*/
