...
module.exports = kind(
	...
	*/
	rendered: function () {
		...
		this.drawers.forEach(function (control) {
			if (control instanceof MoonDrawer) control.drawerRendered(dh);
		});
	},
	...
	*/
	setupHandles: function () {
		...
		this.drawers.forEach(function (drawer) {
			handle = this.$.handles.createComponent(drawer.handle || {}, def);
