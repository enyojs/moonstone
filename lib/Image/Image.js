...
/**
* Contains the declaration for the {@link moon.Image} kind.
...
*
* In addition, `moon.Image` adds {@link moon.Overlay} support to show controls over the image. This
...
* @ui
* @definedby module:moonstone/Image
* @public
*/
module.exports = kind(
