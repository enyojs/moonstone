...
var ScrollControls = module.exports = kind(
	...
	*/
	create: function() {
		...
		this.subControls = ['vthumb', 'hthumb', 'pageUpControl', 'pageDownControl', 'pageLeftControl', 'pageRightControl'];
	...
	scrollerChanged: function(was) {
		...
		if (this.scroller) {
			...
			this.subControls.forEach(this.bindSafely(function (nom) {
				this.$[nom].set('scroller', this.scroller);
			}));
		}
	},
