	...
	*/
	components: [
		{name: 'vColumn', classes: 'moon-scroller-v-column', components: [
			...
			{name: 'vthumbContainer', onmouseup: 'directMove', classes: 'moon-scroller-thumb-container moon-scroller-vthumb-container', components: [
	...
	directMove: function (sender, ev) {
		this.log(ev.offsetY/sender.getBounds().height);
		this.scroller.directMove(ev.offsetY/sender.getBounds().height);
		return true;
	},
