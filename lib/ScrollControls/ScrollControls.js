/**
* Contains the declaration for the {@link moon.ScrollControls} kind.
...
* @definedby module:moonstone/ScrollControls
* @ui
* @public
*/
	...
	*/
	components: [
		{name: 'vColumn', classes: 'moon-scroller-v-column', components: [
			...
			{name: 'vthumbContainer', onmouseup: 'directMove', onmousemove: 'directMove', onmouseleave: 'endDrag', classes: 'moon-scroller-thumb-container moon-scroller-vthumb-container', components: [
		...
		{name: 'hColumn', classes: 'moon-scroller-h-column', components: [
			...
			{name: 'hthumbContainer', onmouseup: 'directMove', onmousemove: 'directMove', classes: 'moon-scroller-thumb-container moon-scroller-hthumb-container', components: [
	...
	directMove: function (sender, ev) {
		if ((ev.type == 'mousemove' && ev.which) || ev.type == 'mouseup') {
			var dir = (sender == this.$.vthumbContainer) ? 'v' : 'h',
				sb = sender.getBounds(),
				ratio = ev.offsetY / sb[dir=='v' ? 'height' : 'width'];
			this.log(sender.id, sb.height, ev.offsetY);
			this.scroller.directMove(ratio, dir);
		}
		return true;
	},
