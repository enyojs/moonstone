enyo.kind({
	...
	audioFiles: [
		{src: "http://enyojs.com/_media/thunder.mp3", trackName: "01-Thunder", artistName: "Sound Effects Artist", albumName: "Sound Effects", duration: "0:22", albumImage: "$lib/moonstone/images/html5-icon.png"},
