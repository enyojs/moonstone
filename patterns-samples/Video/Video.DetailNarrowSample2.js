enyo.kind({
	...
	kind       : 'moon.Panel',
	classes    : 'moon-sample-video-detailnarrowsample2',
	title      : 'Movie Name',
	titleAbove : '03',
	...
	components: [
		{kind: 'HFlexBox', flexSpacing: 20, components: [
			{kind: 'VFlexBox', classes: 'left-column', components: [
			...
			{name: 'more', flex: true, components: [
