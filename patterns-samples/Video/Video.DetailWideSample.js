enyo.kind({
	...
	kind       : 'moon.Panel',
	classes    : 'moon-sample-video-detailwidesample',
	title      : 'Movie Name',
	titleAbove : '03',
	...
	components: [
		{kind: 'HFlexBox', flexSpacing: 10, classes: 'enyo-fit', components: [
			...
			{kind: 'VFlexBox', flex: true, classes: 'middle-column', components: [
...
enyo.ready(function(){
	var sampleModel = new enyo.Model({
		...
		valueHD        : '$6.99',
		value3D        : '$7.99',
		synopsisHeader : '<b>Starring: </b><a href="#">Actor Name</a>, <a href="#">Actor Name</a>, and <a href="#">Actor Name</a>',
		synopsisBody   : 'Pixar genius reigns in this funny romantic comedy, which stars a robot who says absolutely \
			...
			the first few minutes of the film. As the last robot left on earth, Wall-E (voiced by Ben Burtt) is one small \
			robot--with a big, big heart--who holds the future of earth and mankind squarely in the palm of his metal hand. \
			He\'s outlasted all the "Waste Allocation Load Lifter Earth-Class" robots that were assigned some 700 years \
			ago to clean up the environmental mess that man made of earth while man vacationed aboard the luxury spaceship Axiom.'
	});
