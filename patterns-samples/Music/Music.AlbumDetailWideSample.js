...
enyo.kind({
	...
	components: [
		{classes: "moon-5h", components: [
			{name: "cover", kind: "enyo.Image", style: "width: 350px; height: 350px;"},
			{kind: "moon.Table", classes: "enyo-table-fit", components: [
				{components: [
					{content: "Released"},
					{name: "releaseDate"}
				]},
		...
		{kind: "VFlexBox", flex:true, components: [
			{kind: "moon.Divider", content: "Top 11 Tracks"},
			{kind: "moon.Scroller", flex: true, horizontal: "hidden", components: [
...
enyo.kind({
    name: 'moon.sample.music.AlbumDetailWideSampleController',
...
enyo.ready(function () {
	...
	app = new enyo.Application({
		controllers: [
			{name: 'album', kind: 'moon.sample.music.AlbumDetailWideSampleController'}
		],
		view: {
			name: 'moon.sample.music.AlbumDetailWideSampleMain',
			classes: 'enyo-unselectable moon',
			components: [
				{kind: 'enyo.Spotlight'},
				{kind: 'moon.sample.music.AlbumDetailWideSample', classes: 'enyo-fit', controller: '.app.controllers.album'}
			]
		}
	});
