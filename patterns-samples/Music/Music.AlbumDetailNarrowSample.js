...
enyo.kind({
	...
	titleBelow: '',
	components: [
		{kind: 'HFlexBox', style: 'height: 200px', flexStretch: false, flexSpacing: 30, components: [
			{name: 'cover', kind: 'enyo.Image', style: 'height: 200px; width: 200px;'},
			{kind: 'VFlexBox', flex: true, flexSpacing: 20, components: [
				{name: 'album', style: 'font-weight: bold'},
				{kind: 'HFlexBox', name: 'albumInfo', flexSpacing: 200, components: [
					{components: [
						{content: 'Artist'},
						{content: 'Released'},
						{content: 'Genre'}
