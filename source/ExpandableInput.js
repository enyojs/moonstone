...
enyo.kind({
	...
	components: [
		{name: "headerWrapper", kind: "moon.Item", classes: "moon-expandable-picker-header-wrapper", onSpotlightFocused: "headerFocused", ondown: "headerDown", ontap: "expandContract", components: [
