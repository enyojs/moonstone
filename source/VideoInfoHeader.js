...
enyo.kind({
	...
	components: [
		...
		{name: "subTitleDivider", classes: "moon-video-player-info-subtitle-divider", content:"|"},	
	...
	observers: {
		updateDivider: ["subTitle", "subSubTitle"]
	},
	create: function() {
	...
	updateDivider: function() {
		this.$.subTitleDivider.setShowing(this.subTitle && this.subSubTitle);
	}
});
