	...
	enyo.kind(
		...
		*/
		updatePagingControlState: function () {
			...
			//pageDownControl
			(b.top >= -1 * m.bottomBoundary) || !canVScroll ? disable.push('pageDownControl') : enable.push('pageDownControl');

			//pageLeftControl
			(b.left <= 0) || !canHScroll || !canVScroll ? disable.push('pageLeftControl') : enable.push('pageLeftControl');

			//pageRightControl
			(b.left >= -1 * m.rightBoundary) || !canVScroll ? disable.push('pageRightControl') : enable.push('pageRightControl');
