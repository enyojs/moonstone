...
enyo.kind({
	...
	_isInput : function(oControl) {
		return ( oControl instanceof moon.Input || oControl instanceof moon.RichText || oControl instanceof moon.TextArea
		);
	},
	...
	onSpotlightSelect : function(oSender, oEvent) {
		...
		if (oInput && oInput.hasFocus() && oEvent) {
			...
			// Allow keydown to bubble
			return true;
			// Prevent onSpotlightLeft to bubble
		}
	},
