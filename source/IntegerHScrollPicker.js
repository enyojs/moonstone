...
*/
enyo.kind({
	name: "moon.IntegerHScrollPicker",
	published: {
		value: null,
		min: 0,
		max: 9,
	...
	components: [
		{name:"leftOverlay", classes:"moon-scroll-picker-overlay-container-left", showing:false, components:[
			{name:"overlayTest", classes:"moon-scroll-picker-overlay-left"},
		...
		{name:"rightArrowContainer", classes:"right-arrow-container", components:[
			{classes:"right-arrow-border"},
			{name:"rightArrow", classes:"right-arrow", ondown:"next", onup:"resetOverlay", onleave:"resetOverlay"}
		]},
		{name:"leftArrowContainer", classes:"left-arrow-container", components:[
			{classes:"left-arrow-border"},
			{name:"upArrow", classes:"left-arrow", ondown:"previous", onup:"resetOverlay", onleave:"resetOverlay"}
		]},
