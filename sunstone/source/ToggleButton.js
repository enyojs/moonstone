/**
	_sun.ToggleButton_ is a control that looks like a switch with labels for
...
enyo.kind({
	...
	components: [
		{name: "contentOn", classes: "sun-toggle-button-content on"},
		{name: "contentOff", classes: "sun-toggle-button-content off"},
		{name: "knobContent", classes: "sun-toggle-button-knob"}
	],
	create: function() {
	...
	updateVisualState: function() {
		...
		this.$.knobContent.setContent(((this.value) ? this.onKnobContent : this.offKnobContent) || "");
